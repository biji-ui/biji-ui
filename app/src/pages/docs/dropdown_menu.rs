...
pub fn DropdownMenuExample() -> impl IntoView {
    ...
    view! {
        ...
        >
            <menu::Trigger class="inline-flex h-10 w-10 items-center justify-center rounded-full border text-sm font-medium text-foreground focus-visible:ring-offset-background border-border-input bg-background-alt shadow-btn hover:bg-muted focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible focus-visible:ring-foreground active:scale-98">
                <icons::Ellipsis class="h-6 w-6 text-foreground"></icons::Ellipsis>
            </menu::Trigger>
            <menu::Content
                class="w-56 min-w-[8rem] flex-col rounded-md border bg-popover p-1 text-popover-foreground shadow-md focus:outline-none"
